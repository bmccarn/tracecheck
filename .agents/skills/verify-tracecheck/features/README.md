...
- CLI exit codes are part of the contract: `0` no findings or success, `1` needs attention, `2` error, `3` inconclusive.
...
- [Provider configuration](./provider-configuration.md): key, endpoint, and model selection for TypeSafe and OpenRouter. Live and offline.
